...
var Data = (function () {
  ...
  var KITCHEN = {
    ...
    foods: [
      ...
      { id: 'k8',  icon: '🍲|food/food_budae.png', name: '부대찌개',  grade: 3, at: 17, bonus: 0.03,  sec: 1900, need: { mt: 4, ch: 2, gj: 2, ms: 1 } },
  ...
  var QUESTS = [
    ...
    { id: 'q_up',     kind: 'up',     icon: '⬆️|quest/q_up.png', goal: 2,   name: '업그레이드 2개 사기' },
  ...
  var ACHIEVEMENTS = [
    { id: 'ac1',  icon: '👋|achv/ac1.png', name: '첫 손님',        desc: '처음으로 조리하기',              prog: function (s) { return { cur: s.taps, goal: 1 }; }, check: function (s) { return s.taps >= 1; } },
    { id: 'ac2',  icon: '💪|achv/ac2.png', name: '손맛 견습',      desc: '100번 조리하기',                 prog: function (s) { return { cur: s.taps, goal: 100 }; }, check: function (s) { return s.taps >= 100; } },
    { id: 'ac3',  icon: '🦾|achv/ac3.png', name: '조리 기계',      desc: '1,000번 조리하기',               prog: function (s) { return { cur: s.taps, goal: 1000 }; }, check: function (s) { return s.taps >= 1000; } },
    { id: 'ac4',  icon: '🔨|achv/ac4.png', name: '무쇠 손목',      desc: '10,000번 조리하기',              prog: function (s) { return { cur: s.taps, goal: 10000 }; }, check: function (s) { return s.taps >= 10000; } },
    { id: 'ac5',  icon: '🪙|achv/ac5.png', name: '첫 매출',        desc: '누적 1,000원 벌기',              prog: function (s) { return { cur: s.runEarned, goal: 1000 }; }, check: function (s) { return s.runEarned >= 1000; } },
    { id: 'ac6',  icon: '💵|achv/ac6.png', name: '동네 맛집',      desc: '누적 100만원 벌기',              prog: function (s) { return { cur: s.runEarned, goal: 1000000 }; }, fmt: 'num', check: function (s) { return s.runEarned >= 1e6; } },
    { id: 'ac7',  icon: '💎|achv/ac7.png', name: '지역 명물',      desc: '누적 10억원 벌기',               prog: function (s) { return { cur: s.runEarned, goal: 1000000000 }; }, fmt: 'num', check: function (s) { return s.runEarned >= 1e9; } },
    { id: 'ac8',  icon: '🏆|achv/ac8.png', name: '전국구',         desc: '누적 1조원 벌기',                prog: function (s) { return { cur: s.runEarned, goal: 1000000000000 }; }, fmt: 'num', check: function (s) { return s.runEarned >= 1e12; } },
    { id: 'ac9',  icon: '🌟|achv/ac9.png', name: '억만장자 분식',  desc: '누적 1해원 벌기',                prog: function (s) { return { cur: s.runEarned, goal: 1e+20 }; }, fmt: 'num', check: function (s) { return s.runEarned >= 1e20; } },
    { id: 'ac10', icon: '🧑‍🍳|achv/ac10.png', name: '사장님 소리',   desc: '알바생 10명 고용',               prog: function (s) { return { cur: genCount(s, 'g1'), goal: 10 }; }, check: function (s) { return genCount(s, 'g1') >= 10; } },
    { id: 'ac11', icon: '🍲|achv/ac11.png', name: '냄비 부자',      desc: '떡볶이 냄비 25개',               prog: function (s) { return { cur: genCount(s, 'g2'), goal: 25 }; }, check: function (s) { return genCount(s, 'g2') >= 25; } },
    { id: 'ac12', icon: '🛵|achv/ac12.png', name: '배달 왕국',      desc: '배달 오토바이 25대',             prog: function (s) { return { cur: genCount(s, 'g6'), goal: 25 }; }, check: function (s) { return genCount(s, 'g6') >= 25; } },
    { id: 'ac13', icon: '🏬|achv/ac13.png', name: '프랜차이즈',     desc: '지점 10개 오픈',                 prog: function (s) { return { cur: genCount(s, 'g7'), goal: 10 }; }, check: function (s) { return genCount(s, 'g7') >= 10; } },
    { id: 'ac14', icon: '🚀|achv/ac14.png', name: '우주 진출',      desc: '우주 분식 스테이션 1개',         prog: function (s) { return { cur: genCount(s, 'g10'), goal: 1 }; }, check: function (s) { return genCount(s, 'g10') >= 1; } },
    { id: 'ac15', icon: '📦|achv/ac15.png', name: '만물상',         desc: '모든 종류의 설비 1개씩 보유',    prog: function (s) { return { cur: GENERATORS.filter(function (g) { return genCount(s, g.id) >= 1; }).length, goal: GENERATORS.length }; }, check: function (s) { return GENERATORS.every(function (g) { return genCount(s, g.id) >= 1; }); } },
    { id: 'ac16', icon: '✨|achv/ac16.png', name: '첫 재개업',      desc: '환생 1회',                       prog: function (s) { return { cur: s.prestiges, goal: 1 }; }, check: function (s) { return s.prestiges >= 1; } },
    { id: 'ac17', icon: '🌀|achv/ac17.png', name: '윤회의 사장',    desc: '환생 5회',                       prog: function (s) { return { cur: s.prestiges, goal: 5 }; }, check: function (s) { return s.prestiges >= 5; } },
    { id: 'ac18', icon: '🔮|achv/ac18.png', name: '분식의 화신',    desc: '명성 100 보유',                  prog: function (s) { return { cur: s.fame, goal: 100 }; }, check: function (s) { return s.fame >= 100; } },
    { id: 'ac19', icon: '😴|achv/ac19.png', name: '방치의 미학',    desc: '오프라인 수익 1회 수령',         prog: function (s) { return { cur: s.offlineClaims, goal: 1 }; }, check: function (s) { return s.offlineClaims >= 1; } },
    { id: 'ac20', icon: '⏳|achv/ac20.png', name: '하루 영업',      desc: '총 플레이 시간 24시간',          prog: function (s) { return { cur: s.playTime, goal: 86400 }; }, fmt: 'time', check: function (s) { return s.playTime >= 86400; } },
    { id: 'ac21', icon: '🌟|achv/ac21.png', name: '황금 손님',      desc: '황금 손님 1명 잡기',             prog: function (s) { return { cur: s.goldens, goal: 1 }; }, check: function (s) { return s.goldens >= 1; } },
    { id: 'ac22', icon: '💫|achv/ac22.png', name: '황금 인맥',      desc: '황금 손님 50명 잡기',            prog: function (s) { return { cur: s.goldens, goal: 50 }; }, check: function (s) { return s.goldens >= 50; } },
    { id: 'ac23', icon: '🎯|achv/ac23.png', name: '연속 조리',      desc: '콤보 50 달성',                   prog: function (s) { return { cur: s.bestCombo, goal: 50 }; }, check: function (s) { return s.bestCombo >= 50; } },
    { id: 'ac24', icon: '📣|achv/ac24.png', name: '호객의 달인',    desc: '손님 몰이 10회 사용',            prog: function (s) { return { cur: s.boosts, goal: 10 }; }, check: function (s) { return s.boosts >= 10; } },
    { id: 'ac25', icon: '📅|achv/ac25.png', name: '개근 사장',      desc: '7일 연속 출석',                  prog: function (s) { return { cur: s.dailyStreak, goal: 7 }; }, check: function (s) { return s.dailyStreak >= 7; } },
    { id: 'ac26', icon: '🚨|achv/ac26.png', name: '현행범 체포',    desc: '도둑 1명 직접 잡기',             prog: function (s) { return { cur: s.thievesCaught, goal: 1 }; }, check: function (s) { return s.thievesCaught >= 1; } },
    { id: 'ac27', icon: '🥋|achv/ac27.png', name: '분식집 자경단',  desc: '도둑 25명 직접 잡기',            prog: function (s) { return { cur: s.thievesCaught, goal: 25 }; }, check: function (s) { return s.thievesCaught >= 25; } },
    { id: 'ac28', icon: '🚓|achv/ac28.png', name: '든든한 순찰',    desc: '경찰이 도둑을 10번 잡아줌',      prog: function (s) { return { cur: s.thiefSaves, goal: 10 }; }, check: function (s) { return s.thiefSaves >= 10; } },
    { id: 'ac29', icon: '🧑‍💼|achv/ac29.png', name: '믿음직한 점장',  desc: '점장이 대신 산 설비 100개',      prog: function (s) { return { cur: s.autoBought, goal: 100 }; }, check: function (s) { return s.autoBought >= 100; } },
    { id: 'ac30', icon: '🌀|achv/ac30.png', name: '백 번의 재개업',  desc: '환생 100회',                     prog: function (s) { return { cur: s.prestiges, goal: 100 }; }, check: function (s) { return s.prestiges >= 100; } },
    { id: 'ac31', icon: '💠|achv/ac31.png', name: '명성 100만',      desc: '명성 100만 보유',                prog: function (s) { return { cur: s.fame, goal: 1000000 }; }, fmt: 'num', check: function (s) { return s.fame >= 1e6; } },
    { id: 'ac32', icon: '👑|achv/ac32.png', name: '분식 왕조',       desc: '분식 왕조 10레벨',               prog: function (s) { return { cur: (s.fameLv.f_legend || 0), goal: 10 }; }, check: function (s) { return (s.fameLv.f_legend || 0) >= 10; } },
    { id: 'ac33', icon: '♾️|achv/ac33.png', name: '천문학적',        desc: '누적 1극원 벌기',                prog: function (s) { return { cur: s.totalEarned, goal: 1e+48 }; }, fmt: 'num', check: function (s) { return s.totalEarned >= 1e48; } },
    { id: 'ac34', icon: '📋|achv/ac34.png', name: '성실한 사장',     desc: '퀘스트 10개 완료',               prog: function (s) { return { cur: s.questsDone, goal: 10 }; }, check: function (s) { return s.questsDone >= 10; } },
    { id: 'ac35', icon: '🗂️|achv/ac35.png', name: '퀘스트 수집가',   desc: '퀘스트 60개 완료',               prog: function (s) { return { cur: s.questsDone, goal: 60 }; }, check: function (s) { return s.questsDone >= 60; } },
    { id: 'ac36', icon: '⭐|achv/ac36.png', name: '스타 셰프 입성',   desc: '스타 셰프 도전에서 별 1개',      prog: function (s) { return { cur: s.bestMichelin, goal: 1 }; }, check: function (s) { return s.bestMichelin >= 1; } },
    { id: 'ac37', icon: '🌟|achv/ac37.png', name: '5스타 셰프',      desc: '스타 셰프 도전에서 별 5개',      prog: function (s) { return { cur: s.bestMichelin, goal: 5 }; }, check: function (s) { return s.bestMichelin >= 5; } }
  ];
